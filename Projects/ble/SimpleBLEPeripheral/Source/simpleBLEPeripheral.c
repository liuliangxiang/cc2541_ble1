...
//  Batt_AddService();                              // Batt Service
  ...
  RegisterForKeys( simpleBLEPeripheral_TaskID );   //  Ò»¶¨ÐèÒªÌí¼ÓÕâ¸ö£¬ ·ñÔò°´¼ü²»Æð×÷ÓÃ
...
uint8 simpleProfileReadConfig(uint16 uuid, uint8 *newValue)
{
    ...
    switch ( uuid )
    {
      ...
      case SIMPLEPROFILE_CHAR9_UUID:
        ...
        {
            uint16 adc4, adc5;
            // ×¢Òâ£¬ 14bit²ÉÑùÊ±£¬½ö13bitÓÐÐ§£¬¹Ê ÐèÒª  &0x1fff, Õâ¸ö¾Í±ðÎÊ°¢ÄªÎÒÁË£¬ Ïê¼ûÊý¾ÝÊÖ²á
...
#if 0
                // ×÷Îª²âÊÔ£¬ °Ñ¶Áµ½µÄÊý¾ÝÒ²Í¨¹ý´®¿Ú·µ»Ø£¬ ÕâÖ»ÊÇÒ»¸ötest¹¦ÄÜ£¬ Äã¿ÉÒÔ°ÑÈ¥µô
