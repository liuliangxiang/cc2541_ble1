...
// Length of Characteristic 5 in bytes
#define SIMPLEPROFILE_CHAR5_LEN          5     // ÎÂ¶È¸üÐÂÊ±¼ä 4×Ö½Ú
#define SIMPLEPROFILE_CHAR6_LEN          4     // ÎÂ¶ÈÉÏ±¨
#define SIMPLEPROFILE_CHAR7_LEN          20    // Éè±¸Ãû³Æ
#define SIMPLEPROFILE_CHAR8_LEN          4     // ×î¸ß×îµÍÎÂ¶È±¨¾¯Öµ
#define SIMPLEPROFILE_CHAR9_LEN          2     // ADC4 ADC5 ²ÉÑù
#define SIMPLEPROFILE_CHARA_LEN          4     // ËÄÂ· pwm Êä³ö
